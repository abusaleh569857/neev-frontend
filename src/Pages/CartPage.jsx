...
const CartPage = () => {
  ...
  return (
    <div className="bg-[#f5f5f5] py-10 px-4 min-h-screen font-sans">
      ...
      <div className="flex flex-col md:flex-row gap-6 justify-center mt-6 mb-16 md:mb-2">
        <button
          onClick={() => navigate(-1)}
          className="bg-gray-400 hover:bg-gray-500 text-white px-8 py-3 rounded font-bold text-lg"
        >
          🔙 আগের পেইজে ফিরে যান
        </button>
        <button
          onClick={handleOrderClick}
          className="bg-[#ff003c] hover:bg-[#e60036] text-white px-8 py-3 rounded font-bold text-lg"
        >
          ✅ অর্ডার করুন
        </button>
      </div>
