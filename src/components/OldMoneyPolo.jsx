...
const OldMoneyPolo = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/products/old-money-polo")
      .then((response) => {
  ...
  return (
    <div className="container mx-auto p-4 font-sans">
      <h2 className="text-xl font-medium mb-4 pb-2 border-b-2 border-gray-200">
        Exclusive Old Money Polo T-Shirt
      </h2>
        ...
        {products.map((product, index) => {
          ...
          return (
            <div
              ...
              className={`relative bg-white rounded-sm shadow-md p-3 md:p-4 transition-all duration-300 border hover:border-[#ff003c] opacity-0 transform translate-y-8 animate-card ${isClicked}`}
            ...
            >
              ...
              <img
                ...
                alt={product.title}
                className="w-full h-48 md:h-60 object-cover rounded-sm mb-3 transform hover:scale-105 transition-transform duration-300 ease-in-out"
              />
