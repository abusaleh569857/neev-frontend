        ...
        {products.map((product) => {
          ...
          return (
            <div
              ...
              className={`relative bg-white rounded-sm shadow-md p-3 md:p-4 transition-all duration-300 border hover:border-[#ff003c] ${isClicked}`}
            >
              {/* Discount Badge */}
              {discount > 0 && (
              ...
              <img
                ...
                alt={product.title}
                className="w-full h-48 md:h-60 object-cover rounded-sm mb-3 transform hover:scale-110 transition-transform duration-300 ease-in-out"
              />
